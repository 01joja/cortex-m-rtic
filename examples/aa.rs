...
pub mod app {
    ...
    #[allow(non_snake_case)]
    #[allow(non_camel_case_types)]
    pub struct __rtic_context_foo_context {}
    impl __rtic_context_foo_context {
        #[inline(always)]
    ...
    #[allow(non_snake_case)]
    #[allow(non_camel_case_types)]
    pub struct __rtic_context_bar_context {}
    impl __rtic_context_bar_context {
        #[inline(always)]
        pub unsafe fn new(priority: &rtic::export::Priority) -> Self {
    ...
    pub fn __rtic_monotonic_MyMono_foo_spawn_after(
        duration: <MyMono as rtic::Monotonic>::Duration,
        _0: i32,
    ) -> Result<foo::MyMono::SpawnHandle, (i32,)> {
        let instant = monotonics::MyMono::now();
        __rtic_monotonic_MyMono_foo_spawn_at(instant + duration, _0)
    }
    ...
    #[link_section = ".uninit.rtic_MyMono_baz"]
    #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)]
    #[doc(hidden)]
    static __rtic_monotonic_baz_MyMono_INSTANTS: rtic::RacyCell<
        [core::mem::MaybeUninit<<Systick<100> as rtic::Monotonic>::Instant>; 1],
    > = rtic::RacyCell::new([core::mem::MaybeUninit::uninit()]);
    #[allow(non_snake_case)]
    #[allow(non_camel_case_types)]
    pub struct __rtic_monotonic_MyMono_baz_spawn_handler {
        #[doc(hidden)]
        marker: u32,
    }
    impl core::fmt::Debug for __rtic_monotonic_MyMono_baz_spawn_handler {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            f.debug_struct("MyMono::SpawnHandle").finish()
        }
    }
    impl __rtic_monotonic_MyMono_baz_spawn_handler {
        pub fn cancel(self) -> Result<(), ()> {
            rtic::export::interrupt::free(|_| unsafe {
                let timer_queue = &mut *__rtic_monotonic_MyMono_timer_q.get_mut();
                if let Some((_task, index)) = timer_queue.cancel_marker(self.marker) {
                    let msg = (&*baz::__internal_message_list.get())
                        .get_unchecked(usize::from(index))
                        .as_ptr()
                        .read();
                    (&mut *baz::__internal_function_queue.get_mut())
                        .split()
                        .0
                        .enqueue_unchecked(index);
                    Ok(msg)
    ...
    /// so if you use a non-resetable timer use `spawn_at` when in `#[init]`
    #[allow(non_snake_case)]
    pub fn __rtic_monotonic_MyMono_baz_spawn_after(
        duration: <MyMono as rtic::Monotonic>::Duration,
    ) -> Result<baz::MyMono::SpawnHandle, ()> {
        let instant = monotonics::MyMono::now();
        __rtic_monotonic_MyMono_baz_spawn_at(instant + duration)
    }
    /// Spawns the task at a fixed time instant.
    /// Needs access to the software tasks function and input queue.
    #[allow(non_snake_case)]
    pub fn __rtic_monotonic_MyMono_baz_spawn_at(
        instant: <MyMono as rtic::Monotonic>::Instant,
    ) -> Result<baz::MyMono::SpawnHandle, ()> {
        unsafe {
            let input = ();
            if let Some(index)
                = rtic::export::interrupt::free(|_| {
                    (&mut *baz::__internal_function_queue.get_mut()).dequeue()
                }) {
                (&mut *baz::__internal_message_list.get_mut())
                    .get_unchecked_mut(usize::from(index))
                    .as_mut_ptr()
                    .write(input);
                (&mut *__rtic_monotonic_baz_MyMono_INSTANTS.get_mut())
                    .get_unchecked_mut(usize::from(index))
                    .as_mut_ptr()
                    .write(instant);
                rtic::export::interrupt::free(|_| {
                    ...
                    let nr = rtic::export::NotReady {
                        instant,
                        index,
                        task: __rtic_monotonic_schedule_tasks::baz,
                        marker,
                    };
                    __rtic_monotonic_TIMER_QUEUE_MARKER
                        .get_mut()
    ...
    static __rtic_monotonic_MyMono_timer_q: rtic::RacyCell<
        rtic::export::TimerQueue<Systick<100>, __rtic_monotonic_schedule_tasks, 3>,
    > = rtic::RacyCell::new(
    ...
    unsafe fn SysTick() {
        while let Some((task, index))
            ...
            match task {
                ...
                __rtic_monotonic_schedule_tasks::baz => {
                    rtic::export::interrupt::free(|_| {
                        (&mut *baz::__internal_PRIO_REQUEST_Q.get_mut())
                            .split()
                            .0
                            .enqueue_unchecked((
                                baz::__internal_dispatcher_task_name::baz,
                                index,
                            ))
                    });
                    rtic::pend(
    ...
    pub mod baz {
        ...
        #[allow(non_snake_case)]
        pub mod MyMono {
            pub use super::super::__rtic_monotonic_MyMono_baz_spawn_after as spawn_after;
            pub use super::super::__rtic_monotonic_MyMono_baz_spawn_at as spawn_at;
            pub use super::super::__rtic_monotonic_MyMono_baz_spawn_handler as SpawnHandle;
        }
        pub use super::__rtic_software_tasks_prio_1 as __internal_dispatcher_task_name;
        pub use super::__rtic_dispatcher_request_queue_prio_1 as __internal_PRIO_REQUEST_Q;
    ...
    pub fn __rtic_sw_task_baz_spawn() -> Result<(), ()> {
        ...
        unsafe {
            if let Some(index)
                ...
                rtic::export::interrupt::free(|_| {
                    (&mut *__rtic_dispatcher_request_queue_prio_1.get_mut())
                        .enqueue_unchecked((__rtic_software_tasks_prio_1::baz, index));
                });
                rtic::pend(lm3s6965::interrupt::SSI0);
                Ok(())
            } else {
                ...
                || {
                            ...
                            .dequeue()
                    {
                        match task {
                            ...
                            __rtic_software_tasks_prio_1::baz => {
