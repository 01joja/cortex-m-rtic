...
pub mod app {
    ...
    static __rtic_internal_shared_resource_shared: rtic::RacyCell<
    ...
    impl<'a> rtic::Mutex for shared_resources::shared_that_needs_to_be_locked<'a> {
        ...
        fn lock<RTIC_INTERNAL_R>(
            ...
            unsafe {
                rtic::export::lock(
                    __rtic_internal_shared_resource_shared.get_mut() as *mut _,
                    self.priority(),
                    CEILING,
    ...
    mod rtic_ext {
        ...
        unsafe extern "C" fn main() -> ! {
            ...
            __rtic_init_resources(|| {
                ...
                __rtic_internal_shared_resource_shared
                    .get_mut()
